...
// https://github.com/xamarin/Xamarin.Forms/blob/5.0.0/Xamarin.Forms.Platform.iOS/CollectionView/ObservableItemsSource.cs
namespace ReorderableCollectionView.Forms
{
    internal class ObservableItemsSource : IItemsViewSource, IObservableItemsViewSource
    {
        ...
        {
            //checking if the indes is in range should help a lot here
            if (index < 0)
                return -1;
